...
csvdata = [["Site","Server_Group","Service","Gateway_Group_Name","KRP_Alias_Name","Inbound_Port","Priority","Internal_Ip_Host","Outbound_Server_Port","Gateway Name","KRP IP Address"]]
